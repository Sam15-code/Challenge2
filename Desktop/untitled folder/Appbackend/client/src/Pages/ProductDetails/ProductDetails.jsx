...
import DescriptionAndReview from "../../Components/ProductDetails/DescriptionAndReview/DescriptionAndReview";
  ...
  return (
    <Box>
      ...
      <Box className={container}>
        ...
        <DescriptionAndReview product={product} setproduct={setproduct} />
      </Box>
    </Box>
  );
};
